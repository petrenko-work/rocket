        ...
        <div class="container">
            <div class="contactsFlex">
                ...
                <div class="contactsItem">
                    <h2>Время работы</h2>
                    <ul>
                        <li class="clockIcon">пн-сб: 10:00-20:00<br><span class="hiddenElem">пн-</span>вс: 11:00-18:00
                        </li>
                        <li class="please">Перед приездом к нам в гости,<br> позвоните зарание, пожалуйста,<br> чтобы
                            специалист, с которым Вы<br> хотите пообщаться был в офисе
                        </li>
                    </ul>
                </div>
            </div>
